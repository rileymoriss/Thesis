...
Thus doing things on a parabolic allows us to induce said actions up to the whole group, whist maintaining the nice property of being reductive. This is the technique of ``parabolic induction'' [Bernstein - Representations of p-Adic groups, Thm 10] \todo{fix ref}that we wont explicitly talk about here but which is happening secretly in the background in \ref{automorphic_isotypic_subspaces}.
