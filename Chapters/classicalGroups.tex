...
\begin{remark}
    Often the unitary groups are considered classical, as is the case in \cite{jiangResiduesEisensteinSeries2008}.
\end{remark}
...
\begin{definition}
    A subgroup \(P\subseteq G\) is called \textbf{parabolic} if \(G/P\) is a complete variety. Equivalently we can ask for \(P\) to contain a Borel (see \ref{borel_torus}).
\end{definition}
