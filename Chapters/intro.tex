...
\begin{Theorem}[\cite{follandCourseAbstractHarmonic2016}, 5.2, 5.12]
...
In 1940 Weil worked out the theory for locally compact Abelian groups, proving the general case of Bochners theorem \cite[Thm. 4.18]{follandCourseAbstractHarmonic2016}. The groups that we are interested in however are neither compact,  \(\A_\Q^\times\), nor Abelian, \(\GL_n\).
