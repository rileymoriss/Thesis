...
\begin{example}[Dirichlet L-functions]
	Recall that a Dirichlet character \(\chi\) is a character of the group \((\Z/N\Z)^*\) and a Grossencharacter \(\chi'\) is a character of the group \(\A_F^\times/F^\times\). Through the series of maps 
